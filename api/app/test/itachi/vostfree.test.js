const vostfree = require("../../lib/itachi/vostfree");

test('itachi-vostfree | Get search results for "L\'attaque des Titans" on vostfree', async () => {
...
test('itachi-vostfree | Get streaming links for "L\'attaque des Titans" on vostfree', async () => {
