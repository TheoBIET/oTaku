...
const VOSTFREE = {
    ...
    /**
     * Get a lot of anime links from VostFree
     * @param {string} name - The name of the anime to search
     * @return {Promise} A promise that will resolve with the list of anime links
     */
    ...
    /**
     * Get a streaming link from a given anime /manga on Vostfree
     * @param {string} animeURL - The anime URL (ex: https://vostfree.tv/manga/tokyo-ghoul)
     * @returns {Promise} A promise that will resolve with the streaming link
     */
